    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "seed": ("INT", {"default": 0, "min": 0, "max": 0xffffffffffffffff, "tooltip": "Seed for the sampler. Used for determinisitc results with some models."}),
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "steps": ("INT", {"default": 20, "min": 1, "tooltip": "Number of steps for the sampler."}),
                "cfg": ("FLOAT", {"default": 3.5, "tooltip": "Classifier-Free Guidance scale for the sampler."}),
                "sampler_name": (comfy.samplers.KSampler.SAMPLERS, {"tooltip": "Choose the sampler to use for sampling."}),
                "scheduler": (comfy.samplers.KSampler.SCHEDULERS, {"tooltip": "Choose the scheduler to use for sampling."}),
